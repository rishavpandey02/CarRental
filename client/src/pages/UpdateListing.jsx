...
export default function CreatingListing() {
  ...
  return (
   <main className='p-3 max-w-4xl mx-auto'>
    <h1 className='text-white text-4xl font-semibold text-center mt-9 mb-5'>Update Your Car Listing</h1>
    <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex flex-col flex-1'>
            ...
            <button disabled={loading || uploading} className='disabled:opacity-60 text-white p-3 bg-blue-700 rounded-lg mt-8'>{loading ? 'Updating...' : 'Update Listing'}</button>
